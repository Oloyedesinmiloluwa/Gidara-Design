...
const CardGroup = () => {
    return (
        <div className="card-group">
            <div className="card">
                <div style={{ backgroundImage: `url('${cardImage1}')` }} className="card-image"></div>
            ...
            <div className="card">
                <div style={{ backgroundImage: `url('${cardImage2}')` }} className="card-image"></div>
                <div className="card-text">
                    <h3>Two</h3>
                    <p>Place any text you want here etc.
                    We invest between N2m - N5m in
            ...
            <div className="card">
                <div style={{ backgroundImage: `url('${cardImage3}')` }} className="card-image"></div>
                <div className="card-text">
                    <h3>Three</h3>
                    <p>Place any text you want here etc.
                    We invest between N2m - N5m in
