    ...
    return (
        <div className="slider-group">
            <div className="slider">
                <div style={{ backgroundImage: `url('${image1}')`, backgroundPosition: 'right'}} className="slider-image"></div>
            ...
            <div className="slider">
                <div style={{ backgroundImage: `url('${image2}')`}} className="slider-image"></div>
                <div className="slider-body">
                    <div className="slider-button" style={{ margin: '45px 0px 10px 0px' }}>
                        <CustomButton style={{ marginRight: '25px' }} point="left" />
                        <CustomButton point="right" />
            ...
            <div className="slider">
                <div style={{ backgroundImage: `url('${image3}')`, backgroundPosition: 'left'}} className="slider-image"></div>
                <div className="slider-body">
                    <div className="slider-button" style={{ margin: '45px 0px 10px 0px' }}>
                        <CustomButton style={{ marginRight: '25px' }} point="left" />
                        <CustomButton point="right" />
